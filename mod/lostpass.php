...
function lostpass_post(&$a) {
	...
	$res = mail($email, t("Password reset requested at " . $a->config['sitename'] ,$email_tpl, "From: " t('Administrator@') . $_SERVER[SERVER_NAME]);
	...
	if(x($_GET,'verify')) {
		...
		if($r) {
			...
			$o .= replace_macros($tpl,array(
				...
				notice( t("Your password has been reset.") . EOL);
			...
			$res = mail($email, t("Your password has changed at ") . $a->config['sitename'],
